	...
	<div class="carousel-inner">
		<div class="item">
			...
			<div class="carousel-caption">
				<h2 style="color: blacks;"> Making Learning Easy</h2>
			</div>
		</div>
		...
		<div class="item">
			...
			<div class="carousel-caption">
				<a href="takeassessment"><h2 style="color: black; ">Take Assessment And Discuss</h2>
                </div>
            </div>
        </div>
        <!-- Controls -->
				...
				<div class="panel-body">
					<ul style="list-style-type:disc">
						<li>
							...
							admission procedure, discussion forum, register for the course, fee structure etc. without going to
...
<li>Monitor student learning progress.</li>
<li>Supports discussion and interaction features.</li>
...
<li>jQuery</li>
	...
	<div class="row">
		...
		<div class="col-md-6">
			<p>The CLOUD CLASSROOMS by <strong>Bed Boys 007</strong> includes:</p>
			<ul>
